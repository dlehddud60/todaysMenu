...
public abstract class CommonFile {
    ...
    public static void commonFileMethod(BoardDTO freeboarddto, CommonFileDTO commonFileDTO, CommonFileRepository commonFileRepository, HttpServletRequest request) throws FileSizeExaption, FileExtensionExaption {
    ...
    public static void commonFileMethod(RestaurantDTO restaurantDTO, CommonFileDTO commonFileDTO, CommonFileRepository commonFileRepository, HttpServletRequest request) throws FileSizeExaption, FileExtensionExaption {
        HttpSession session = request.getSession();
        MemberDTO memberSession = (MemberDTO) session.getAttribute("memberDTO");
        ...
        for (int i = 0; i < comFileList.size(); i++) {
            ...
            commonFileDTO.setTcft_input_id(memberSession.getTmt_login_id());
            commonFileDTO.setTcft_input_ip(request.getRemoteAddr());
            commonFileDTO.setTcft_parent_seq(restaurantDTO.getTrt_seq());
