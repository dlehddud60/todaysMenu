...
,   TMT_PASSWORD                VARCHAR2(200) NOT NULL
,   TMT_NAME                    VARCHAR2(20) NOT NULL
,   TMT_GENDER                  CHAR(1) NOT NULL
,   TMT_BIRTH_DAY               DATE NOT NULL
,   TMT_DELETE_YN               NUMBER(1) NOT NULL
,   TMT_INPUT_DATE              DATE NOT NULL
,   TMT_MODER_DATE              DATE
,   CONSTRAINT PK_MEMBER_ID PRIMARY KEY (TMT_SEQ)
,   CONSTRAINT MEMBER_LOGIN_ID UNIQUE (TMT_LOGIN_ID)
);
...
COMMENT ON COLUMN TM_MEMBER_TBL.TMT_PASSWORD IS '비밀번호';
COMMENT ON COLUMN TM_MEMBER_TBL.TMT_NAME IS '이름';
COMMENT ON COLUMN TM_MEMBER_TBL.TMT_GENDER IS '성별';
COMMENT ON COLUMN TM_MEMBER_TBL.TMT_BIRTH_DAY IS '생년월일';
COMMENT ON COLUMN TM_MEMBER_TBL.TMT_DELETE_YN IS '삭제 여부';
